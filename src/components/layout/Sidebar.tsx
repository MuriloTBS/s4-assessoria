...
import {
  LayoutDashboard, FolderKanban, Users, Calculator, Settings, LogOut, ChevronRight,
} from 'lucide-react'
  ...
  return (
    <aside className="flex flex-col w-64 min-h-screen bg-[#0D1B2A] border-r border-[#2a3f5f] shrink-0">
      ...
      <div className="flex items-center gap-3 px-6 py-5 border-b border-[#2a3f5f]">
        <div className="w-9 h-9 rounded-xl bg-blue-500 flex items-center justify-center text-white font-bold text-sm">S4</div>
        <div>
